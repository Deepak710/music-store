...
create table User(name varchar(50), role varchar(20), password varchar(20), enabled boolean, address varchar(255), phone decimal(10), email varchar(100), constraint pk_User_email primary key(email));
...
create table Song(name varchar(50), track_no integer, rate integer, preview varchar(150), album varchar(50), artist varchar(50), rating integer, bought integer, constraint pk_Song_id primary key(track_no, album, artist));
create table Cart(id identity, email varchar(100), total double, constraint fk_User_email foreign key(email) references User(email));
...
insert into Song (name, track_no, rate, preview, album, artist, rating, bought) values('Love The Way You Lie', 1, 10, 'eminem-recovery-1.mp3', 'Recovery', 'Eminem', 5, 0);
insert into Song (name, track_no, rate, preview, album, artist, rating, bought) values('Space Bound', 2, 8, 'eminem-recovery-2.mp3', 'Recovery', 'Eminem', 4, 0);
insert into Song (name, track_no, rate, preview, album, artist, rating, bought) values('Not Afraid', 3, 10, 'eminem-recovery-3.mp3', 'Recovery', 'Eminem', 5, 0);
